# Generated by Powerlevel10k configuration wizard on 2023-04-02 at 15:49 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    # NOTE: comment out these lines to only show branch
  ...
  # Foreground color.
  typeset -g POWERLEVEL9K_VI_MODE_FOREGROUND=254
