...
local config = {
  ...
  mouse_bindings = {
    -- Fix: CTRL-LeftMouse prints error: No tag in nvim with wezterm
    {
...
--   -- Issue #1813: Error Failed to create window: The OpenGL implementation is too old to work on Windows 11 in VirtualBox.
